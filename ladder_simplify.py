...
from ladder_search import evaluate, logic_str, program_size, program_str
from ladder_sim import And, Coil, Contact, Or, Program, Pulse, Rung, Timer
  ...
  for _ in range(max_iter):
    ...
    for r in prog.rungs:
      ...
      if s is False:
        ...
        writers = sum(1 for x in prog.rungs if x.coil.device == r.coil.device)
        if writers == 1:
